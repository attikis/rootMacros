...
// Setup ROOT
  ...
  // Choose DataSample to run on!
  TString DataSample;
  bool runProgram = 1; 
  std::cout << "*** Please type below the dataset you want to access. Possible options are: \n\"hplus80\", \"hplus140\", \"qcd160\", \"qcd30\", \"qcd80\", \"qcd170\", \"qcd300\" " << std::endl;
  cin >> DataSample ;
  // *****************************************************************************************************
  // Add Files on a TChain
  // *****************************************************************************************************
  TChain myChain("Events");
  std::cout << "*** Accessing data: \" " << DataSample << " \" " << std::endl;
  std::cout << "*** Attempting to add TFiles to a TChain ..." << std::endl;
  // Signal
