...
// Sun Aug  1 23:22:33 2010 by ROOT version 5.26/00
// from TTree Events/
...
#ifdef alpha_T_cxx
alpha_T::alpha_T(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     
     std::cout << "\n Loading TFile /afs/cern.ch/user/a/attikis/scratch0/AnalysisPack/test/HPlusOut_M80.root" << std::endl;    
     ...
     // myChain->Add("/afs/cern.ch/user/a/attikis/scratch0/AnalysisPack/test/alpha/HPlusOut_M160.root");
     
     // myChain->Print(); // DO NOT DELETE
     //      tree = myChain;
...
Int_t alpha_T::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alpha_T::LoadTree(Long64_t entry)
{
...
void alpha_T::Show(Long64_t entry)
{
...
Int_t alpha_T::Cut(Long64_t entry)
{
