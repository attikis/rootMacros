...
int functions()
{
  ...
  TCanvas* c= CreateCanvas("c", "Marina", 600, 600); // new TCanvas("c","MarinaCanvas",0,0,600,600);
...
TCanvas* CreateCanvas(const char* name, const char* title, Int_t width=600, Int_t height=600){
