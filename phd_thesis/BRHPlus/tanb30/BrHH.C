...
void BrHH(void) {
  ...
  const TString TanBetaValue = "3"; // 3, 30
  ...
  v_MyBranch.push_back("BR_H_ChaAChaA+BR_H_ChaAChaB+BR_H_ChaBChaA");
  v_MyBranch.push_back("BR_H_NeuANeuA+BR_H_NeuANeuB+BR_H_NeuANeuC+BR_H_NeuANeuD+BR_H_NeuBNeuB+BR_H_NeuBNeuC+BR_H_NeuBNeuD+BR_H_NeuCNeuC+BR_H_NeuCNeuD");
