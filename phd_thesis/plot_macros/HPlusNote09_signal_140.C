...
#include <vector>
  ...
  // Char_t  *FileName = "PYTHIA6_Tauola_TTbar_Hplus160_TauNu_10TeV_cff_py_GEN_MC_20k_analysis.root";
  // Char_t  *FileName = "PYTHIA6_Tauola_TTbar_Hplus160_TauNu_10TeV_cff_py_GEN_MC_10k_analysis.root";
  // Char_t  *FileName = "testing_signal.root";  
  
  Char_t  *ReadPath = "/afs/cern.ch/user/a/attikis/scratch0/CMSSW_3_1_2/src/analysis/myAnalyzer/HPlusNote09_signal_140/res/";
  ...
  SetHistoStyle2( p4_genP_tauFromH_Visible_Pt_Histo , mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 500.0, 2, "#tau^{+}_{vis}", "m_{H^{+}} =  140 GeV/c^{2}" );
  counter++;
  
  // Eta of Visible tauFromH
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( p4_genP_tauFromH_Visible_Eta_Histo , mcColour("eta"), "#eta", "" , -5.0 , 5.0, 2, "#tau^{+}_{vis}","#eta");
  counter++;
  
  // Pt of nuSumFromHDecay
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( p4_nuSumFromHDecay_Pt_Histo ,  mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 500.0, 2, "P_{T} ( #nu_{H^{+} #rightarrow #tau^{+} #nu} + #nu_{#tau^{+} #rightarrow hadr #nu})", "m_{H^{+}} =  140 GeV/c^{2}" );
  counter++;
 
  // mcMET
  v_myCanvas[counter]->cd(1);
  // all cuts, except MET  cut
  SuperImpose3Histos( genP_EvtMet_Histo, genP_EvtMet_hadrWdecay_Histo, genP_EvtMet_leptWdecay_Histo, "W #rightarrow ALL", "W #rightarrow hadrons", "W #rightarrow leptons", 0.0 , 500.0, "E_{T}^{miss} (GeV)", "E_{T}^{miss}", 2);
  ...
  v_myCanvas[counter]->cd(1); 
  SuperImpose3Histos( VCuts:MtOfH_tauFromHVis_Met_Histo, VCuts:MtOfH_tauFromHVis_Met_hadrWdecay_Histo, VCuts:MtOfH_tauFromHVis_Met_leptWdecay_Histo, "W #rightarrow ALL", "W #rightarrow hadrons", "W #rightarrow leptons", 0.0 , 500.0, "M_{T} (GeV/c^{2})", "M_{T}(#tau^{+}_{vis} + E_{T}^{miss})", 2);
  AddTText_PRELIM()->Draw();
  counter++;
  
  // Pt of b (H+ side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2(VCuts:p4_genP_beautyFromTop_Pt_Histo, mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 400.0, 2, "b_{t #rightarrow H^{+}b}", "m_{H^{+}} =  140 GeV/c^{2}" );
  counter++;
  
  // Pt of b (W- side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_beautyBarFromTopBar_Pt_Histo, mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 400.0, 2, "#bar{b}_{#bar{t} #rightarrow W^{-}#bar{b}}", "m_{H^{+}} =  140 GeV/c^{2}"); 
  counter++;
 
  // DeltaR (bFromH , tauFromHVis)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2b( VCuts:DeltaR_tauFromHVis_beautyFromTop_Histo, mcColour("deltaR"), "#DeltaR", "" , 0.0 , 6.5, 2, "#DeltaR(#tau^{+}_{vis} , b_{t #rightarrow H^{+}b})", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;
  
  // Pt of top (H+ side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_topFromHb_Pt_Histo, mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 800.0, 2, "P_{T} of t_{t #rightarrow H^{+}b}", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;
  
  // Pt of top (W- side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_topBarFromWb_Pt_Histo, mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 800.0, 2, "#bar{t}_{#bar{t} #rightarrow W^{-}#bar{b}}", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;
  ...
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_tauFromW_Visible_Pt_Histo , mcColour("pt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 200.0, 2, "#tau^{-}_{vis}", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;

  // Eta of associated tauVis
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_tauFromW_Visible_Eta_Histo , mcColour("eta"), "#eta", "" , -5.0 , 5.0, 2, "#tau^{-}_{vis}", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;
  
  // Pt of Ldg Charged Trk from associated tauVis
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:genP_tauFromW_LdgPt_Cha_Histo , mcColour("ldgpt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 100.0, 1, "#tau^{-}_{Ldg_Ch}", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;

  // Pt of Ldg Charged OR Neutral Trk from associated tauVis
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:genP_tauFromW_LdgPt_Histo , mcColour("ldgpt"), "p_{T}^{MC} (GeV/c)", "" , 0.0 , 100.0, 1, "#tau^{-}_{Ldg}", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;
  
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2b( VCuts:DeltaPhi_Visible_Htau_MET_Histo, mcColour("deltaPhi"), "rads" , ""  , 0.0 , 3.2, 5, "#Delta #phi(#tau^{+}_{vis} , E_{T}^{miss} )", "m_{H^{+}} =  140 GeV/c^{2}");
  counter++;
  ...
  v_myCanvas[counter]->cd(1);
  SuperImpose3Histos( genP_EvtMet_Histo, genP_EvtMet_hadrWdecay_Histo, genP_EvtMet_leptWdecay_Histo, "W #rightarrow ALL", "W #rightarrow hadrons", "W #rightarrow leptons", 0.0 , 300.0, "E_{T}^{miss} (GeV)", "E_{T}^{miss} ", 2);
  AddTText_PRELIM()->Draw();
  counter++;
  ...
  v_myCanvas[counter]->cd(1);
  // all cuts except MET
  SuperImpose3Histos( VCuts3:genP_nNeutrinos_tauFromH_hadrDecay_Histo, VCuts3:genP_nNeutrinos_tauFromH_hadrDecay_HadrWdecay_Histo, VCuts3:genP_nNeutrinos_tauFromH_hadrDecay_LeptWdecay_Histo, "W #rightarrow ALL", "W #rightarrow hadrons", "W #rightarrow leptons", 0.0 , 15.0, "Multiplicity", "Neutrino Multiplicity", 1);
  // all cuts
  ...
  v_myCanvas[counter]->cd(1);
  // all cuts, except MET  cut
  SuperImpose3Histos( VCuts3:genP_EvtMet_Histo, VCuts3:genP_EvtMet_hadrWdecay_Histo, VCuts3:genP_EvtMet_leptWdecay_Histo, "W #rightarrow ALL", "W #rightarrow hadrons", "W #rightarrow leptons", 0.0 , 400.0, "E_{T}^{miss} (GeV)", "E_{T}^{miss}", 2);
  // all cuts
