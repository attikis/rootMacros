...
#include <vector>
  ...
  Char_t  *ReadPath = "/afs/cern.ch/user/a/attikis/scratch0/CMSSW_3_1_2/src/analysis/myAnalyzer/HPlusNote09_signal_160b/res/";
  ...
  SetHistoStyle2( p4_genP_tauFromH_Visible_Pt_Histo , mcColour("pt"), "GeV", "" , 0.0 , 500.0, 4, "P_{T} of #tau^{+}_{vis}", "m_{H^{+}} =  160 GeV" );
  counter++;
  ...
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( p4_nuSumFromHDecay_Pt_Histo ,  mcColour("pt"), "GeV", "" , 0.0 , 500.0, 4, "P_{T} ( #nu_{H^{+} #rightarrow #tau^{+} #nu} + #nu_{#tau^{+} #rightarrow hadr #nu})", "m_{H^{+}} =  160 GeV" );
  counter++;
  ...
  // Pt of b (H+ side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2(VCuts:p4_genP_beautyFromTop_Pt_Histo, mcColour("pt"), "GeV", "" , 0.0 , 400.0, 4, "P_{T} of b_{t #rightarrow H^{+}b}", "m_{H^{+}} =  160 GeV" );
  counter++;
  
  // Pt of b (W- side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_beautyBarFromTopBar_Pt_Histo, mcColour("pt"), "GeV", "" , 0.0 , 400.0, 4, "P_{T} of #bar{b}_{#bar{t} #rightarrow W^{-}#bar{b}}", "m_{H^{+}} =  160 GeV"); 
  counter++;
 
  // DeltaR (bFromH , tauFromHVis)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:DeltaR_tauFromHVis_beautyFromTop_Histo, mcColour("deltaR"), "#Delta R", "" , 0.0 , 10.0, 1, "#Delta R(#tau^{+}_{vis} , b_{t #rightarrow H^{+}b})", "m_{H^{+}} =  160 GeV");
  counter++;
  
  // Pt of top (H+ side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_topFromHb_Pt_Histo, mcColour("pt"), "GeV", "" , 0.0 , 800.0, 4, "P_{T} of t_{t #rightarrow H^{+}b}", "m_{H^{+}} =  160 GeV");
  counter++;
  
  // Pt of top (W- side)
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_topBarFromWb_Pt_Histo, mcColour("pt"), "GeV", "" , 0.0 , 800.0, 4, "P_{T} of #bar{t}_{#bar{t} #rightarrow W^{-}#bar{b}}", "m_{H^{+}} =  160 GeV");
  counter++;
  ...
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_tauFromW_Visible_Pt_Histo , mcColour("pt"), "GeV", "" , 0.0 , 800.0, 5 , "P_{T} of #tau^{-}_{vis}", "m_{H^{+}} =  160 GeV");
  counter++;

  // Eta of associated tauVis
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:p4_genP_tauFromW_Visible_Eta_Histo , mcColour("eta"), "#eta", "" , -10.0 , 10.0, 2, "Eta of #tau^{-}_{vis}", "m_{H^{+}} =  160 GeV");
  counter++;
  
  // Pt of Ldg Charged Trk from associated tauVis
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:genP_tauFromW_LdgPt_Cha_Histo , mcColour("ldgpt"), "GeV", "" , 0.0 , 100.0, 1, "P_{T} of #tau^{-}_{Ldg_Ch}", "m_{H^{+}} =  160 GeV");
  counter++;

  // Pt of Ldg Charged OR Neutral Trk from associated tauVis
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2( VCuts:genP_tauFromW_LdgPt_Histo , mcColour("ldgpt"), "GeV", "" , 0.0 , 100.0, 1, "P_{T} of #tau^{-}_{Ldg}", "m_{H^{+}} =  160 GeV");
  counter++;
  
  v_myCanvas[counter]->cd(1);
  SetHistoStyle2b( VCuts:DeltaPhi_Visible_Htau_MET_Histo, mcColour("deltaPhi"), "rads" , ""  , 0.0 , 3.2, 5, "#Delta #phi(#tau^{+}_{vis} , E_{T}^{miss} )", "m_{H^{+}} =  160 GeV");
  counter++;
