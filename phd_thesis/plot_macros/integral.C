...
#include <TH1D>
  ...
  Super2HistosAndAxis( ttbarFile, signalFile_140, histo1 , histo2, 0.0, 500.0, 2, "SM" , "m_{H^{+}} =  140 GeV/c^{2}" , "M_{T}( #tau^{+}_{vis} , E_{T}^{miss} MC )", "E_{T}^{miss} MC (GeV)");
  GetIntegral(ttbarFile, histo1, 80, 1000);
  GetIntegral(signalFile_140, histo2, 140, 1000);
  counter++;
