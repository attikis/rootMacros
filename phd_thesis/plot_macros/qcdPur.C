...

{
  ...
  Char_t *FileNameForSave = "qcdPurities";
  Char_t *SavePath = "/afs/cern.ch/user/a/attikis/qcdMeasurementByIsolationVeto/figures/";
  char *ReadFilePath =  "/afs/cern.ch/user/a/attikis/qcdMeasurementByIsolationVeto/pur/HltJet30u_MetCut_36X_MC_pattuple_v6_1/";
  ...
  v_FileNames.push_back("HltJet30u_MetCut_36X_MC_pattuple_v6_1_purities.dat");
  ...
  v_ReadPath.push_back("/afs/cern.ch/user/a/attikis/qcdMeasurementByIsolationVeto/pur/HltJet30u_MetCut_36X_MC_pattuple_v6_1/");
  ...
  Double_t yValues[]           = {10.0, 20.0, 30.0, 40.0, 50.0, 60.0, 70.0};
