...
//#######################################################################
void TauEmbedding_Preselection_Purities(void) {
  ...
  /// Main manipulations
  //////////////////////////////////////////////  
  v_Data.push_back( 33930 );
  v_Data_Error.push_back( 184 );
  //
  v_MC.push_back( 34560 );
  v_MC_Error.push_back( 256 );
  //
  v_Wjets.push_back( 19685 );
  v_Wjets_Error.push_back( 180 );
  //
  v_TTbar.push_back( 8831 );
  v_TTbar_Error.push_back( 41 );
  //
  v_DrellYan.push_back( 2640 );
  v_DrellYan_Error.push_back( 31 );
  //
  v_QCD.push_back( 2035 );
  v_QCD_Error.push_back( 174 );
  //
  v_SingleTop.push_back( 1017.8 );
  v_SingleTop_Error.push_back( 6.7 );
  //
  v_Diboson.push_back( 350.2 );
  v_Diboson_Error.push_back( 3.6 );
