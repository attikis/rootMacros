...
//        Comments:  
//#######################################################################
#include "QCDMeasurement.h"


////////////////////////
QCDMeasurement::QCDMeasurement(void){
  // #ifdef myDEBUGGER 
  std::cout << "\n*** QCDMeasurement::QCDMeasurement() *** This is the constructor" << std::endl;
  // #endif
...
QCDMeasurement::~QCDMeasurement(void){
  // #ifdef myDEBUGGER
  std::cout << "\n*** QCDMeasurement::~QCDMeasurement() *** This is the destructor." << std::endl;
  // #endif
}
...
////////////////////////
void QCDMeasurement::Initialize(std::vector<TString> &v_MyDatasets, TString MulticrabDirPath, TString FolderName, TString HistoName){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::Inititialize() ***" << std::endl;
#endif
...
//////////////////////// 
void QCDMeasurement::Initialize(std::vector<TString> &v_MyDatasets, TString MulticrabDirPath,  TString FolderName, TString TreeName, TString BranchName, TString MyCut, TString HistoName, const int nBins, const double xMin, const double xMax, TString EventWeight, const bool bApplyEventWeight){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::Initialize(Trees) ***" << std::endl;
#endif
...
//////////////////////// 
void QCDMeasurement::Initialize(std::vector<TString> &v_MyDatasets, TString MulticrabDirPath,  TString FolderName, TString TreeName, TString BranchName, TCut MyCut, TString HistoName, const int nBins, const double xMin, const double xMax, TString EventWeight, const bool bApplyEventWeight){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::Initialize(Trees) ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::InitStructures(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::InitStructures() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetCustomLumi(double newLumi){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::SetCustomLumi() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::InitStructure(DatasetStruc &s){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::InitStructure() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::PrintStructure(DatasetStruc *s){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::PrintStructure() *** " << std::endl;  
#endif
...
////////////////////////
void QCDMeasurement::PrintStructures(bool bVersbose){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::PrintStructures() *** " << std::endl;  
#endif
...
//////////////////////// 
void QCDMeasurement::PrintHelper(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::PrintHelper() *** " << std::endl;  
#endif
...
//////////////////////// 
void QCDMeasurement::PrintHistoInfo(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::PrintHistoInfo() *** " << std::endl;  
#endif
...
//////////////////////// 
void QCDMeasurement::PrintHistoInfo(const int binNumber){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::PrintHistoInfo() *** " << std::endl;  
#endif
...
////////////////////////
void QCDMeasurement::Reset(){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::Reset() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::InitVectors(){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::InitVectors() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::GetRootFiles(TString MulticrabDirPath, std::vector<TString> &v_MyDatasets){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetRootFiles() *** " << std::endl;
#endif
  ...
  if(v_MyDatasets.size() == 0){
    std::cout << "*** ERROR! No Datasets passed to QCDMeasurement::Initialize() *** Aborting retrieval of ROOT files." << std::endl;
    exit(-1);
    return;
  }
...
////////////////////////
void QCDMeasurement::DefineSupportedDatasets(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::DefineSupportedDatasets() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::PrintSupportedDatasets(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::PrintSupportedDatasets() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::FillStructure(TString &MulticrabDirPath, TString &MyDatasetName, DatasetStruc &s, bool b_IsData, bool b_IsQCD, bool b_IsDiboson, bool b_IsSingleTop, bool b_IsSignal, bool b_IsHplusHminus){

#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::FillStructure() ***" << std::endl;
#endif
...
////////////////////////
bool QCDMeasurement::GetTFile(TString &MulticrabDirPath, TFile *&f, TString &MyDatasetName){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetTFile() ***" << std::endl;
#endif
...
////////////////////////
bool QCDMeasurement::OpenTFile(TString &MulticrabDirPath, TFile *&f, TString &MyDatasetName){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetTFile() ***" << std::endl;
#endif
...
////////////////////////
bool QCDMeasurement::CheckTFile(TFile* f){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::CheckTFile() ***" << std::endl;
#endif
...
void QCDMeasurement::GetLumiesAndCrossSectionsAndNormFactors(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetLumiesAndCrossSectionsAndNormFactors() *** " << std::endl;
#endif
...
void QCDMeasurement::GetXSectionsAndNormFactors(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetXsectionsAndNormFactors() *** " << std::endl;
#endif
...
////////////////////////
double QCDMeasurement::GetHistoCrossSection(TFile *f){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetHistoCrossSection() *** " << std::endl;
#endif
...
////////////////////////
double QCDMeasurement::GetHistoLuminosity(TFile *f){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetHistoLuminosity() *** " << std::endl;
#endif
...
////////////////////////
double QCDMeasurement::GetHistoAllEvents(TFile* f){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetHistoAllEvents() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::GetHistosFromRootFiles(void){
#ifdef myDEBUGGER
...
//////////////////////// 
void QCDMeasurement::GetHistosFromRootFilesTrees(const int nBins, const double xMin, const double xMax){
#ifdef myDEBUGGER 
...
////////////////////////
void QCDMeasurement::PrepareHistosForDrawing( bool bApplyMCHistoWeights){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::PrepareHistosForDrawing() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::PrepareHistosForDrawingMSSMYield( bool bApplyMCHistoWeights){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::PrepareHistosForDrawing() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::StorePoissonError(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::StorePoissonError() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::ApplyMCHistoWeights(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::ApplyMCHistoWeights() *** " << std::endl;
...
////////////////////////
void QCDMeasurement::ApplyHistoWeight(TH1D *&histo, double weight){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::ApplyHistoWeight() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::InitHistosAndStacks(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::InitHistosAndStacks() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeData(){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MergeData() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeMC(){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MergeMC() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeQCD(){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::MergeQCD() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeDiboson(){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MergeDiboson() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeSingleTop(){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MergeSingleTop() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeNonQCD(){ // TTbar, W+Jets, Single-Top, Diboson. Drell-Yan
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MergeNonQCD() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MergeSignal(){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MergeSignal() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Merge(TString histoName, TH1D *&h, TString DataType){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::Merge() *** " << std::endl;
...
////////////////////////
void QCDMeasurement::StackMCHistos(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::StackMCHistos() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::StackMCHistosTest(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::StackMCHistos() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::GetMCStatError(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetMCStatError()" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Draw(TString MyOptions, bool bPlotRatio){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::Draw() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawEfficiencies(TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawEfficiencies() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawEfficiencies(TString MyOptions, const double xMin, const double yMin, const double xMax, const double yMax){ //overloaded
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::DrawEfficiencies() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMCPurities(TString MyOptions, TString CutDirection){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::DrawMCPurities() *** " << std::endl;
...
////////////////////////
void QCDMeasurement::DrawDataPurities(TString MyOptions, TString CutDirection){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawDataPurities() *** " << std::endl;
...
////////////////////////
void QCDMeasurement::DrawMCPurities(TString MyOptions, const double xMin, const double yMin, const double xMax, const double yMax, TString CutDirection){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMCPurities() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMssmYield(TString MyOptions, bool bPlotRatio){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::DrawMssmYield() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetHistoStyles(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SetHistoStyles() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetTGraphStyle(TGraph *&graph, Int_t fillColour, Style_t fillStyle, Int_t lineColour, Style_t lineStyle, Int_t lineWidth, Color_t markerColour, Style_t markerStyle, Double_t markerSize){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SetTGraphStyle() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetTGraphStyle(TGraphAsymmErrors *&graph, Int_t fillColour, Style_t fillStyle, Int_t lineColour, Style_t lineStyle, Int_t lineWidth, Color_t markerColour, Style_t markerStyle, Double_t markerSize){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SetTGraphStyle() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetTH1DStyle(TH1D *&histo, Int_t fillColour, Style_t fillStyle, Int_t lineColour, Style_t lineStyle, Int_t lineWidth, Color_t markerColour, Style_t markerStyle, Double_t markerSize){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SetTH1DStyle() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetTH1DStyle(TH1D *&histo, Int_t fillColour, Style_t fillStyle, Int_t lineColour, Style_t lineStyle, Int_t lineWidth){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::SetTH1DStyle() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SetTH1DStyle(TH1D *&histo, Color_t markerColour, Style_t markerStyle, Double_t markerSize){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::SetTH1DStyle() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Create2PadCanvas(TString MyCanvasName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Create2PadCanvas() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CreateCanvas(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CreateCanvas() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CreateCanvas(TString MyCanvasName){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::CreateCanvas() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CreateDumbieHisto(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::CreateDumbieHisto() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawHelper(bool bPlotData, bool bPlotMC, bool bPlotRatio, bool bPlotMCStatErrors, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawHelper() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawEfficienciesHelper(bool bPlotData, bool bPlotMC, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawEfficienciesHelper() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawMCPuritiesHelper(bool bPlotData, bool bPlotMC, TString MyOptions, TString CutDirection){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMCPuritiesHelper() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawDataPuritiesHelper(bool bPlotData, bool bPlotMC, TString MyOptions, TString CutDirection){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawDataPuritiesHelper() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawPurityCorrEfficiencyHelper(TH1D *hBeforeCut_Data, TH1D *hBeforeCut_NonQCD, TH1D *hAfterCut_Data, TH1D *hAfterCut_NonQCD, TString MyOptions, std::vector<double>& fPurityCorrEff_values, std::vector<double>& fPurityCorrEff_errorsLow, std::vector<double>& fPurityCorrEff_errorsHigh, bool bDrawPurityCorrEfficiencyPerBin, double CutValue, TString CutDirection){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawDataPuritiesHelper() ***" << std::endl;
#endif
  std::cout << "*** WARNING! Will calculate error bars according to \"Error Propagation\". This is not strictly speaking correct." << std::endl;  
...
/////////////////////
void QCDMeasurement::CalculatePurityValue(TH1D *hData, TH1D *hEwk, double CutValue, TString CutDirection, bool bApplyConservativeMCSystematics, std::vector<DatasetStruc*> v_Structures, std::vector<double>& v_value, std::vector<double> &v_errorLow, std::vector<double> &v_errorHigh, std::vector<double> &v_ErrorSquared ){
  
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CalculatePurityValue() ***" << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::CalculatePurityError(bool bApplyConservativeMCSystematics, std::vector<DatasetStruc*> v_Structures, std::vector<double> &v_errorLow, std::vector<double> &v_errorHigh, std::vector<double> &v_ErrorSquared){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CalculatePurityError() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::GetEwkMcStatErrorSquared(std::vector<DatasetStruc*> v_Structures, std::vector<double> &v_Errors){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkMcStatErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::GetEwkMcSysErrorSquared(std::vector<DatasetStruc*> v_Structures, std::vector<double> &v_Errors){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkMcSysErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::GetSignalMcStatErrorSquared(std::vector<DatasetStruc*> v_Structures, std::vector<double> &v_Errors){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkMcStatErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::GetSignalMcSysErrorSquared(std::vector<DatasetStruc*> v_Structures, std::vector<double> &v_Errors){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkMcSysErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::QCDMtShapeExtraction_MakeTauPtBinsGraph(const int nTauPtBins, TGraphAsymmErrors *&myTGraph,  TString graphName,  std::vector<double>& y_value,  std::vector<double>& y_errorLow,  std::vector<double>& y_errorHigh){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_MakeTauPtBinsGraph() ***" << std::endl;
#endif
...
/////////////////////
double QCDMeasurement::GetQCDBinRangeErrorSquare(int bin, TString CutDirection){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetQCDBinRangeErrorSquare() ***" << std::endl;
#endif
...
/////////////////////
double QCDMeasurement::GetNonQCDBinRangeErrorSquare(int bin, TString CutDirection){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetNonQCDBinRangeErrorSquare() ***" << std::endl;
#endif
  // Note: For the moment this is only used for QCD Purity measurements, where
  //       a histogram is transformed to a purity histogram. Each bin represents 
  //       the purity of the original histogram, at bin-value cut.
...
/////////////////////
double QCDMeasurement::GetNonQCDTotalErrorSquare(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::GetNonQCDTotalErrorSquare() ***" << std::endl;
#endif
  // Note: For the moment this is only used for QCD Purity measurements, where
  //       a histogram is transformed to a purity histogram. Each bin represents 
  //       the purity of the original histogram, at bin-value cut.
...
/////////////////////
void QCDMeasurement::ConvertToEfficiencyHisto(TH1D *&histo, bool b_IsData){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::ConvertToEfficiencyHisto() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawHelperMssmYield(bool bPlotData, bool bPlotMC, bool bPlotRatio, bool bPlotMCStatErrors, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawHelperMssmYield() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawMssmYieldHisto(void){ // verified to work fine
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMssmYieldHisto() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddDefaultText(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddDefaultText() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddCmsPreliminaryText(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddCmsPreliminaryText() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddEnergy7TeVText(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::AddEnergy7TeVText() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddLuminosityText(TString lumi, TString unit){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddLuminosityText() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::DrawRatioPlot(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawRatioPlot() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::FillHelperStructure(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::FillHelperStructure() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddText(TString text, double textReSizeFactor, const double xPos, const double yPos){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddText() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddText(TString text, double textReSizeFactor, const double xPos, const double yPos, bool bSetNDC){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddText() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::RemoveBinLabels(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::RemoveBinLabels() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::RemoveBinLabels(TH1D *histo){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::RemoveBinLabels() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::RemoveBinLabels(TMultiGraph *mgraph){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::RemoveBinLabels() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::RemoveBinLabels(TF1 *f){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::RemoveBinLabels() ***" << std::endl;
#endif

  const int NBins = f->GetXaxis()->GetNbins();
    
    /// Loop over all TGraph bins
    for(int j = 1; j <= NBins; j++){
      
      f->GetXaxis()->SetBinLabel(j, "");
...
/////////////////////
void QCDMeasurement::SwitchToEfficiencyPhaseSpace(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::SwitchToEfficiencyPhaseSpace() ***" << std::endl;
#endif
...
///////////////////// 
void QCDMeasurement::CopyMassPointHistoToSignalHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CopyMassPointHistoToSignalHisto()" << std::endl;
#endif
...
/////////////////////
bool QCDMeasurement::LookIfSignalIsPresent(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::LookIfSignalIsPresent()" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CustomizeHisto(double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle, bool setLogy){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CustomizeHisto() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CustomizeHisto(TH1D *&h, double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CustomizeHisto() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CustomizeDumbieHistos(void) {
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CustomizeDumbieHistos() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::CustomizeHistos(double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle, bool setLogy){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CustomizeHistos() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddAllLegends(const TString header, double x1, double y1, double x2, double y2, const char* mc_options){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddAllLegends() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::AddLegend(const TString header, double x1, double y1, double x2, double y2, const char* mc_options){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddLegend() *** " << std::endl;
#endif
...
/////////////////////
TLegend* QCDMeasurement::GetLegends(void){
...
/////////////////////
void QCDMeasurement::AddLegendMssmYield(const TString header, double x1, double y1, double x2, double y2, const char* mc_options){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddLegend() *** " << std::endl;
#endif
...
/////////////////////
TLegend* QCDMeasurement::CreateLegend(const TString header){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CreateLegend() *** " << std::endl;
#endif
...
/////////////////////
TLegend* QCDMeasurement::CreateLegend(const TString header, const double x1, const double x2, const double y1, const double y2 ){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CreateLegend() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::MultiplyHplusWminusSignalByFactor(const double scaleFactor){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MultiplyHplusWminusSignalByFactor() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::MultiplyHplusHminusSignalByFactor(const double scaleFactor){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MultiplyHplusHminusSignalByFactor() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::MultiplyTotalSignalByFactor(const double scaleFactor){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MultiplyTotalSignalByFactor() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::MultiplySignalsByFactor(const double scaleFactor){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MultiplySignalsByFactor() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::SetHPlusBR(const double BranchingRatio){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SetHPlusBR() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::ScaleTTbarToHPlusBR(){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::ScaleTTbarToHPlusBR() *** " << std::endl;
#endif
...
/////////////////////
TH1D* QCDMeasurement::GetStackTotalHistoForMssmYield(THStack *stack, const char *TotalHistoName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetStackTotalHistoForMssmYield() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::Rebin(const int nGroup){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Rebin()" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::RebinHistos(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::RebinHistos()" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::PrintCfgParameters(const char* TDirName, const char* PSetName){
  ...
  std::cout << "\n *** QCDMeasurement::PrintCfgParameters(const char* name) *** NOTE! Dumping Parameters used for histogram production *** \n" << PSet->GetTitle() << std::endl;
...
/////////////////////
void QCDMeasurement::Save(const TString SavePath){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Save() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::SaveHistosToRootFile(const char* MyName, Option_t* MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SaveHistosToRootFile() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::SaveHistoToRootFile(TH1D* histo, const char* MyName, Option_t* MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SaveHistosToRootFile() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::SaveAs(const TString SavePathAndName ){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SaveAs() *** " << std::endl;
#endif
...
/////////////////////
TString QCDMeasurement::GetHistoBinWidth(int iBinNumber, char* cPrecision){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetHistoBinWidth() ***" << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::PushBackMyHistos(void){ // do i need the v_MyTH1D vector?
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::PushBackMyHistos() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::ReadLumiesFromJSON(const char * cFileName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::ReadLumiesFromJSON() *** " << std::endl;
#endif
...
/////////////////////
void QCDMeasurement::GetIntLumiFromStructures(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetIntLumiFromStructures() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::ScaleHistogramsToArea(double fScaleFactor){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::ScaleHistogramsToArea() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetDumbieHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetDumbieHisto() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetSignalHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetSignalHisto() *** " << std::endl;
#endif
...
////////////////////////
THStack* QCDMeasurement::GetMCTHStack(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetMCTHStack() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetDataHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetDataHisto() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetQCDHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetQCDHisto() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetNonQCDHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetQCDHisto() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetPurityHisto(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetPurityHisto() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::PrepareHistos(bool bApplyMCHistoWeights){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::PrepareHistos() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::PrepareHistosMSSMYield(bool bApplyMCHistoWeights){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::PrepareHistos() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMssmYieldTest(TString MyOptions, bool bPlotRatio){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMssmYieldTest() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddCutBox(const double xMin, const double yMin, const double xMax, const double yMax){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddCutBox() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddCutBox(const double xMin, const double yMin, const double xMax, const double yMax, const int fillColour, const int fillStyle){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddCutBox() *** " << std::endl;
#endif
  ...
  TBox *test = new TBox(xMin, yMin, xMax, yMax);
  test->SetFillColor(fillColour);
  test->SetFillStyle(fillStyle);
  test->Draw("same"); 
  AddVerticalLine(xMax, yMin, yMax); // not visible as things 
  dumbie2_TH1D->Draw("sameaxis9");
...
////////////////////////
void QCDMeasurement::AddCutBox2Pad(const double xMin1, const double yMin1, const double xMax1, const double yMax1, const double xMin2, const double yMin2, const double xMax2, const double yMax2){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddCutBox2Pad() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddVerticalLine(const double xValue){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddVerticalLine() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddVerticalLine(const double xValue, const double yMin, const double yMax){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddVerticalLine() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddHorizontalLine(const double yValue){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddHorizontalLine() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddHorizontalLine(const double yValue, const double xMax, const int kColor){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddHorizontalLine() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::AddHorizontalLine(const double yValue, const double xMin, const double xMax){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddHorizontalLine() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawDivision( TH1D *&histoNumerator, TH1D *&histoDenomenator){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawDivision() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetDivision( TH1D *&histoNumerator, TH1D *&histoDenomenator, TString NewHistoName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetDivision() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMultiplication( TH1D *&histo1, TH1D *&histo2, TString NewHistoName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMultiplication() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawHisto( TH2D *&histo1, TString MyOptions, TString CanvasName, TString xTitle, TString yTitle, const double Maximum){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawHisto() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawHisto( TH1D *&histo1, TString MyOptions, TString CanvasName, bool bNormalizeToUnity){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawHisto() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawHisto( TH1D *&histo1, double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle, bool setLogy, TString MyOptions, TString CanvasName, bool bNormalizeToUnity){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawHisto() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawTGraph( TGraph *&graph, double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle, bool setLogy, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawTGraph() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawTGraph( TGraphAsymmErrors *&graph, double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle, bool setLogy, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawTGraph() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMGraph( TMultiGraph *&mgraph, double xMin, double xMax, double yMin, double yMax, TString xTitle, TString yTitle, bool setLogy, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMGraph() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMGraph2Pad( TString MyCanvasName, TMultiGraph *&mgraph1, TLegend *&myLegend1, double xMin1, double xMax1, double yMin1, double yMax1, TString xTitle1, TString yTitle1, bool setLogy1, TString MyOptions1, TMultiGraph *&mgraph2, TLegend *&myLegend2, double xMin2, double xMax2, double yMin2, double yMax2, TString xTitle2, TString yTitle2, bool setLogy2, TString MyOptions2){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMGraph2Pad() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawMGraph( TMultiGraph *&mgraph, bool setLogy, TString MyOptions){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawMGraph() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::DrawHistoSame( TH1D *&histo1, TString MyOptions, bool bNormalizeToUnity){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::DrawHistoSame() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::GetMultiplication( TH1D *&histo1, TH1D *&histo2, TString NewHistoName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetMultiplication() *** " << std::endl;
#endif
...
////////////////////////
TCanvas* QCDMeasurement::GetCanvas(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetCanvas() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Get2011AData42XMC(std::vector<TString> &MyDatasets, TString SignalMassPoint){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get2011AData42XMC() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Get2011AData42XMCNoQCD(std::vector<TString> &MyDatasets, TString SignalMassPoint){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get2011AData42XMCNoQCD() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Get2011AData42XMCNoQCDNoSignal(std::vector<TString> &MyDatasets){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get2011AData42XMCNoQCD() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::GetEPSData42XMC(std::vector<TString> &MyDatasets){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get42XDatasets() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Get42XDatasets(std::vector<TString> &MyDatasets){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get42XDatasets() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Get42XDatasetsNoQCD(std::vector<TString> &MyDatasets){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get42XDatasets_NoQCD() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::Get42XDatasetsNoMC(std::vector<TString> &MyDatasets){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::Get42XDatasets() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::CloseTFiles(void){
#ifdef myDEBUGGER
  std::cout << "*** QCDMeasurement::CloseTFiles() ***" << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetTauCandidatePtBins(const int nTauPtBins, std::vector<TString> &v_MyTauPtBins_Cut, std::vector<TString> &v_MyTauPtBins_CutName, std::vector<TString> &v_MyTauPtBins_EGreaterThan, std::vector<TString> &v_MyTauPtBins_LessThan){

#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetTauCandidatePtBins() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MessageToBeReadByUser(TString Message){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MessageToBeReadByUser() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::MessageToBeReadByUser(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::MessageToBeReadByUser() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetTauLegWeightsRtau07InTauPtBins(const int nTauPtBins, std::vector<double> &v_MyTauPtBinsWeights_value, std::vector<double> &v_MyTauPtBinsWeights_errorLow, std::vector<double> &v_MyTauPtBinsWeights_errorHigh, std::vector<double> &v_MyTauPtBinsWeights_errorSquared, TString HPS, TString Dataset){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetTauLegWeightsRtau07InTauPtBins() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetTauLegWeightsRtau07InTauPtBins_SignalCorrected(const int nTauPtBins, std::vector<double> &v_MyTauPtBinsWeights_value, std::vector<double> &v_MyTauPtBinsWeights_errorLow, std::vector<double> &v_MyTauPtBinsWeights_errorHigh, std::vector<double> &v_MyTauPtBinsWeights_errorSquared, TString signalMass, TString Dataset){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetTauLegWeightsRtau07InTauPtBins_SignalCorrcted() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetRtau07EfficiencyInTauPtBins(const int nTauPtBins, std::vector<double> &v_MyTauPtBinsWeights_value, std::vector<double> &v_MyTauPtBinsWeights_errorLow, std::vector<double> &v_MyTauPtBinsWeights_errorHigh, std::vector<double> &v_MyTauPtBinsWeights_errorSquared, TString HPS, TString Dataset){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetRtau07EfficiencyInTauPtBins() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetTauLegWeightsNoRtauInTauPtBins(const int nTauPtBins, std::vector<double> &v_MyTauPtBinsWeights_value, std::vector<double> &v_MyTauPtBinsWeights_errorLow, std::vector<double> &v_MyTauPtBinsWeights_errorHigh, std::vector<double> &v_MyTauPtBinsWeights_errorSquared, TString HPS, TString Dataset){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetTauLegWeightsNoRtauInTauPtBins() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::GetMetLegWeightInTauPtBins_SignalCorrected(const int nTauPtBins, std::vector<double> &v_MyMetLegTauPtBinsWeights_value, std::vector<double> &v_MyMetLegTauPtBinsWeights_errorLow, std::vector<double> &v_MyMetLegTauPtBinsWeights_errorHigh, std::vector<double> &v_MyMetLegTauPtBinsWeights_errorSquared, TString DeltaPhiCut, TString MetCut, TString signalMass, TString Dataset){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetMetLegWeightInTauPtBins_SignalCorrected() *** " << std::endl;
#endif
...
////////////////////////
TH1D* QCDMeasurement::AddHistos(std::vector<TH1D*> v_MyWeightedHistos, double coefficient, TString histoName){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::AddHistos() *** " << std::endl;
#endif
...
////////////////////////
void QCDMeasurement::SaveValuesAndErrorsToFile(TString fileName, std::vector<double> v_value, std::vector<double> v_errorLow, std::vector<double> v_errorHigh, TString Leg){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::SaveValuesAndErrorsToFile() *** " << std::endl;
#endif
...
///////////////////////
std::vector<DatasetStruc*> QCDMeasurement::GetStructuresVector(void){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::GetStructuresVector() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetTrueEfficiencyErrorForGivenTauPtBin(bool bApplyConservativeMCSystematics, std::vector<DatasetStruc*> v_BeforeCut, std::vector<DatasetStruc*> v_AfterCut, std::vector<double> &v_TrueEff_errorLow, std::vector<double> &v_TrueEff_errorHigh, std::vector<double> &v_TrueEff_ErrorSquared){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetTrueEfficiencyErrorForGivenTauPtBin() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetPurityErrorForGivenTauPtBin(bool bApplyConservativeMCSystematics, std::vector<DatasetStruc*> v_AfterCut, std::vector<double> &v_TrueEff_errorLow, std::vector<double> &v_TrueEff_errorHigh, std::vector<double> &v_TrueEff_ErrorSquared){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetPurityErrorForGivenTauPtBin() *** " << std::endl;
#endif
  std::cout << "*** NOTE! Purity error calculation info follows:" << std::endl;
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetConservativeEwkSystErrorBarsSquaredForMtHisto( const int nTauPtBins, TH1D *hEwk, int TauPtBinCounter, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetConservativeEwkSystErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetEwkJESErrorBarsSquaredForMtHisto(const int nTauPtBins, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins, TString Dataset){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkJESHistoErrorBarsForQCDTransverseMassInTauPtBinsWeights() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetEwkXSectionErrorBarsSquaredForMtHisto( const int nTauPtBins, TH1D *hEwk, int TauPtBinCounter, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkXSectionHistoErrorBarsForQCDTransverseMassInTauPtBinsWeights() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetDataPoissonErrorBarsSquaredForMtHisto( const int nTauPtBins, TH1D *hData, int TauPtBinCounter, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetDataPoissonHistoErrorBarsForQCDTransverseMassInTauPtBinsWeights() *** " << std::endl;
#endif
  v_MtHistoBinErrorsSquaredInTauPtBins.resize(nTauPtBins);
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetDataEwkDifferenceErrorBarsSquaredForMtHisto( const int nTauPtBins, TH1D *hDataMinusEwk, int TauPtBinCounter, std::vector<std::vector<double> > &v_DataMinusEwk_FromMtHisto){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetDataEwkDifferenceErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetEwkMcStatErrorBarsSquaredForMtHisto( const int nTauPtBins, std::vector<DatasetStruc*> v_Structures, int TauPtBinCounter, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkMcStatErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_GetEwkMcSystErrorBarsSquaredForMtHisto( const int nTauPtBins, std::vector<DatasetStruc*> v_Structures, int TauPtBinCounter, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtraction_GetEwkMcSystErrorBarsSquaredForMtHisto() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::QCDMtShapeExtraction_SetErrorBarsForMtHistoNoCorrelations_TauAntiIsolation(std::vector<TH1D*> &v_MyWeightedHistos, std::vector<std::vector<double> > &v_MtHistoBinErrorsSquaredInTauPtBins_Poisson, std::vector<double> &v_MyTauPtBinsWeightsRtau_value, std::vector<double> &v_MyTauPtBinsWeightsRtau_ErrorSquared, std::vector<double> &v_MyTauPtBinsWeightsNoRtau_value, std::vector<double> &v_MyTauPtBinsWeightsNoRtau_ErrorSquared ){
#ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::QCDMtShapeExtractionNoCorrelations_SetErrorBarsForMtHisto_TauAntiIsolation() *** " << std::endl;
#endif
...
///////////////////////
void QCDMeasurement::FitPolynomialToTGraph( TGraphAsymmErrors *Graph, TString myPol, const double xFitRangeMin, const double xFitRangeMax, const int kColour, Style_t lineStyle, Int_t lineWidth){
  // #ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::FitPolynomialToTGraph() *** " << std::endl;
  // #endif
...
///////////////////////
void QCDMeasurement::CustomizeFitBox( TGraphAsymmErrors *Graph, TString ObjectName, const double x1, const double x2, const double y1, const double y2, TString fitFormat){
  // #ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::CustomizeFitBox();" << std::endl;
  // #endif
...
///////////////////////
void QCDMeasurement::ActivatePad( int padNumber){
  // #ifdef myDEBUGGER 
  std::cout << "*** QCDMeasurement::ActivatePad();" << std::endl;
  // #endif
...
////////////////////////
void QCDMeasurement::MakeLine(double eta, const double gradient, double xMin, double xMax){

  // Make Line: y= m*x
  TF1 *f = new TF1("gradient", "[0]*x", xMin, xMax*0.57); 
  f->SetParameter(0, gradient);
  ...
  // Y-axis
  // AddVerticalLine(0.001, -0.01, 10.0); 
  AddText("#font[42]{#eta = 0}", relSize, 0.01, yPos); 
  // X-axis
  TLine *LineAtOne = new TLine(xMin, 0.001, xMax, 0.001);
  LineAtOne->SetLineWidth(3);
  LineAtOne->SetLineStyle(kDashed);
  LineAtOne->SetLineColor(kBlack);
  // LineAtOne->Draw();
  AddText("#font[42]{#eta = #infty}", relSize, 0.90, 0.01);   

  // Print value of line
  char etaName[100];
  sprintf(etaName,"%.1f", eta); 
  // TString text = "#font[42]{#eta = " + TString(etaName) + "}";
  TString text = "#font[42]{" + TString(etaName) + "}";
  
  // Custom eta lines
  if(eta < 0.9){
   
   xPos = f->GetX(yPos);
   AddText(text, relSize, xPos, yPos); 
 }
 else if(eta < 2.6){
 ...
 else std::cout << "*** *** WARNING! Will not add label text (outside custom range)." << std::endl;
