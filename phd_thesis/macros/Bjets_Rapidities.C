...
void Bjets_Rapidities(void) {
  ...
  TString BranchName;
  TString MyEventWeight = "(weightPileup*weightTrigger*weightPrescale*weightBTagging)"; // The correct & full event weight

  // Branches
  TString jetPt       = "jets_p4.Pt()";
  TString jetEta      = "jets_p4.Eta()";
  ...
  // Define your cut
  TString NBjetsDisc = "Sum$(jets_btag > 1.7) >= 5";
  ...
  double yMax = 1E+06;
  TString units  = "GeV/c";
  TString xTitle = "#tau-jet candidate p_{T}";
  TString yTitle = "Events / "; // "Evts / ";

  BranchName = jetEta; // jetPt;

  //////////////////////////////////////////////
  /// Main manipulations
  //////////////////////////////////////////////
  TString MyTCut = PassBtag;
  TString HistoName = "BJets_Rapidities";
  ...
  if(bSavePlots) qcd.SaveAs(SavePath_HPlusNote11+"BJets_Rapidities");
