...
//#######################################################################
void HiggsPotential_Unbounded(void) {
  ...
  // Create the function
  qcd.CreateCanvas("HiggsPotential_Unbounded_1");
  ...
  f1->SetRange(xMin, yMin, xMax, yMax);
  f1->Draw();
  TLine *LineAtxZero = new TLine(0.0, f1->Eval(xMin*(1+0.017)), 0.0, yMax);
  ...
  ////////////////////////////////////////
  // Save plots
  if(bSavePlots) qcd.SaveAs(SavePath+"HiggsPotential_Unbounded_1");
  ...
  qcd.CreateCanvas("HiggsPotential_Unbounded_2");
  // Create the function
  ...
  f2->SetRange(xMin, yMin, xMax, yMax);
  f2->Draw();
  TLine *LineAtxZeroAlt = new TLine(0.0, f2->Eval(xMin*(1+0.010)), 0.0, yMax);
  LineAtxZeroAlt->SetLineWidth(3);
  LineAtxZeroAlt->SetLineStyle(kSolid);
  LineAtxZeroAlt->SetLineColor(kBlack);
  LineAtxZeroAlt->Draw("same");
  LineAtyZero->Draw("same");
  ...
  ////////////////////////////////////////
  // Save plots
  if(bSavePlots) qcd.SaveAs(SavePath+"HiggsPotential_Unbounded_2");
