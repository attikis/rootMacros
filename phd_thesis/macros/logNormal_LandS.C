...
void logNormal_LandS(){
  ...
  // EWKGenuineTau
  double relSystUncertainty_EWKGenuineTau = 0.15; // 0.15=15 % = EWKGenuineTau relative error
  ...
  // QCD
  double relSystUncertainty_QCD = 0.09; // 0.09 = 9 % = QCD relative error
  ...
  if(bSavePlots) qcd.SaveAs(SavePath+"LogNormal_LandS");
