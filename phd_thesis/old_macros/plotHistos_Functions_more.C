...
void PlotTH1( TFile *f1, TString histoName1, Int_t myFillColour1, TString myXaxisTitle = "", TString myYaxisTitle = "",  Double_t xMin, Double_t xMax, Int_t nBins, TString myHeader, TString myLeg ) {
  ...
  if( (xMin == 0.0) && (xMax ==0.0) ){
    clone1->Draw();
    DrawLegend( myHeader, clone1, myLeg, 1 );
  } //end of: if( (xMin == 0) && (mMax ==0) ){

  else{
    clone1->GetXaxis()->SetRangeUser(xMin , xMax);
    clone1->Draw();  
    DrawLegend( myHeader, clone1, myLeg, 5 );
  } //end of: else 
...
void Super4Histos4Dirs( TFile *f,  TString histoDir1, TString histoDir2, TString histoDir3, TString histoDir4, TString Histo1, TString Histo2, TString Histo3, TString Histo4, TString h1_Title, TString h2_Title, TString h3_Title, TString h4_Title, Double_t xMin, Double_t xMax, TString myLeg){
 ...
 //  std::cout << "\n\n\n histoDir2 = " << TString(histoDir2) << std::endl;
  ...
  Draw4Legends( myLeg, clone1, clone2, clone3, clone4, h1_Title, h2_Title, h3_Title, h4_Title, 5);
  
} //end of: void SuperImpose4Histos( TFile *f,  TString histoDir1, TString histoDir2, TString histoDir3, TString histoDir4, TString Histo1, TString Histo2, TString Histo3,  TString Histo4, Double_t xMin, Double_t xMax ){
//*************************************************************************//
...
void Super4Histos2Files( TFile *f1, TFile *f2, TString Histo1, TString Histo2, TString Histo3, TString Histo4, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString leg4, TString myLeg,  TString xTitle ){
  ...
  // Draw Legends  
  Draw4Legends( myLeg, clone1, clone2, clone3, clone4, leg1, leg2, leg3, leg4, 5);
...
void Super5Histos5Files_Norm( TFile *f1, TFile *f2, TFile *f3, TFile *f4, TFile *f5, TString Histo1, TString Histo2, TString Histo3, TString Histo4, TString Histo5, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString leg4, TString leg5, TString myLeg,  TString xTitle ){
  ...
  TH1D *histo5 = (TH1D*)f4->Get(Histo5);
  ...
  clone5->SetLineColor(kPink);
  clone5->SetLineStyle(kDashDotted);
  clone5->SetLineStyle(1);
  ...
  if( (clone1->Integral()!=0) && (clone2->Integral()!=0) && (clone3->Integral()!=0) && (clone4->Integral()!=0) && (clone5->Integral()!=0) ){
    ...
    if( (clone1->Integral()>=clone2->Integral()) && (clone1->Integral()>=clone3->Integral()) && (clone1->Integral()>=clone4->Integral()) && (clone1->Integral()>=clone5->Integral()) ){
      ...
      Double_t normFactor = clone5->Integral();
    }
  ...
  // Draw Legends  
  Draw5Legends( myLeg, clone1, clone2, clone3, clone4, clone5, leg1, leg2, leg3, leg4, leg5, 5);
...
//*************************************************************************//
void SuperImpose2HistosNorm( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg, TString xTitle ){
  ...
  Draw2Legends( myLeg, clone1, clone2, leg1, leg2, 5);
  
} //end of: void SuperImpose2HistosNorm( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle ){
...
// Function to Superimpose 2 histograms, all located in the DIFFERENT paths.
//*************************************************************************//
void SuperImpose2Histos( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg, TString xTitle ){
...
} //end of: void SuperImpose2Histos( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle,){
...
// Function to Superimpose 2 histograms, all located in the DIFFERENT paths.
//*************************************************************************//
void Super2HistosNoAxis( TFile *f1, TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle ){
  ...
  if( ymax1 >= ymax2){
    clone1->GetXaxis()->SetTitle(xTitle);
    clone1->SetAxisRange(0.1, 1.2*ymax1, "Y");
    //
    clone2->GetXaxis()->SetTitle(xTitle);
    clone2->SetAxisRange(0.1, 1.2*ymax1, "Y");
  ...
  if( ymax2 > ymax1){
    ...
    clone1->GetXaxis()->SetTitle(xTitle);
    clone1->SetAxisRange(0.01, 1.5*ymax2, "Y"); // cannot use log-scale if I set ymin=0.
    // clone1->SetLogy();
    //
    clone2->GetXaxis()->SetTitle(xTitle);
    clone2->SetAxisRange(0.01, 1.5*ymax2, "Y"); // cannot use log-scale if I set ymin=0.0
...
} //end of: void SuperHistosNoAxis( TFile *f1, TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg ){
//*************************************************************************//
...
// Function to Superimpose 2 histograms, all located in the DIFFERENT paths. Custom Colours
//*************************************************************************//
void Super2HistosAndAxis( TFile *f1, TFile *f2, TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle, Int_t colour1, Int_t colour2 ){
  //    std::cout <<  "*** void Super2HistosAndAxis() *** WARNING: This Function does not correctly normalise the histograms. Better to use the Function Super2HistosAndScale instead for official use. ***" << std::endl;  
  // First check the TFiles (Zombie or Not)
  checkTFile( f1 );
  checkTFile( f2 );
...
} //end of: void Super2HistosAndAxis( TFile *f1, TFile *f2, TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle, Int_t colour1, Int_t colour2 ){
//*************************************************************************//
...
// Function to Superimpose 2 histograms, all located in the DIFFERENT paths.
//*************************************************************************//
void Super2HistosAndAxis( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle ){
  //    std::cout <<  "*** void Super2HistosAndAxis() *** WARNING: This Function does not correctly normalise the histograms. Better to use the Function Super2HistosAndScale instead for official use. ***" << std::endl;  
  // First check the TFiles (Zombie or Not)
  checkTFile( f1 );
  checkTFile( f2 );
...
} //end of: void SuperHistosAndAxis( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg ){
//***************************************************************//
...
// Function to Superimpose 2 histograms, all located in DIFFERENT paths.
// (Same as void Super2HistosAndAxis but different position of Legend)
//*************************************************************************//
void Super2HistosAndAxisb( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg,  TString xTitle ){
...
//     axis->Draw();
 ...
 // Draw Stats Box
  ...
  // Draw Legends  
  // Draw2Legends( myLeg, clone1, clone2, leg1, leg2, 5);
  Draw2LegendsCustom( myLeg, clone1, clone2, leg1, leg2, 5, 0.45, 0.65, 0.6, 0.8);
  
} //end of: void SuperHistosAndAxisb( TFile *f1, TFile *f2,  TString Histo1, TString Histo2, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString myLeg ){
//*************************************************************************//
...
//*************************************************************************//
void Super3Histos( TFile *f1, TFile *f2, TString Histo1, TString Histo2, TString Histo3, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString myLeg,  TString xTitle ){
  ...
  // Draw Legends  
  Draw3Legends( myLeg, clone1, clone2, clone3, leg1, leg2, leg3, 5);
  
} //end of: void Super3Histos( TFile *f1, TFile *f2, TString Histo1, TString Histo2, TString Histo3, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString myLeg,  TString xTitle ){
//*************************************************************************//
...
//*************************************************************************//
void Super3Histos_Norm( TFile *f1, TFile *f2, TString Histo1, TString Histo2, TString Histo3, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString myLeg,  TString xTitle ){
...
} //end of: void Super3Histos_Norm( TFile *f1, TFile *f2, TString Histo1, TString Histo2, TString Histo3, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString myLeg,  TString xTitle ){
//********************************************************************//
...
// Function to Superimpose 4 histograms, all located in the same path.
//********************************************************************//
void SuperImpose4Histos( TH1D* h1, TH1D* h2, TH1D* h3,  TH1D* h4, TString h1_Title, TString h2_Title, TString h3_Title, TString h4_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg){
  
  // std::cout << "*** void SuperImpose4Histos( ) *** Entering Function." << std::endl;
  gPad->Update();
  
  TH1D *clone1 = (TH1D*)h1->Clone();
  // clone1->SetName( "hClone1" );  // set the name of the Histo-clone to something unique  
  clone1->SetLineColor(kAzure-4);
  clone1->SetFillColor(kAzure-4);
  //  clone1->SetFillStyle(3003);
  clone1->SetLineStyle(kSolid);
  ...
  // clone2->SetName( "hClone2" );  // set the name of the h-clone to something unique  
  clone2->SetLineColor(kRed+1);
  //clone2->SetFillColor(kRed+1);
  ...
  TH1D* clone3 = (TH1D*)h3->Clone();
  // clone3->SetName( "hClone3" );  // set the name of the h-clone to something unique  
  clone3->SetLineColor(kOrange);
  //clone3->SetFillColor(kOrange);
  clone3->SetFillStyle(3005);
  clone3->SetLineStyle(kDashed);
  ...
  TH1D* clone4 = (TH1D*)h4->Clone();
  // clone4->SetName( "hClone4" );  // set the name of the h-clone to something unique  
  clone4->SetLineColor(kBlack);
  clone4->SetFillColor(0);
  // clone4->SetFillStyle(3004);
  clone4->SetLineStyle(kSolid);
  // clone4->SetLineStyle(1);
  ...
  // std::cout << "*** void SuperImpose4Histos( ) *** Leaving Function." << std::endl;
  
} //end of: void SuperImpose4Histos( TH1D* h1, TH1D* h2, TH1D* h3,  TH1D* h4, Double_t xMin, Double_t xMax, TString myLeg){
...
//********************************************************************//
void SuperImpose3Histos( TH1D* h1, TH1D* h2, TH1D* h3, TString h1_Title, TString h2_Title, TString h3_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg, Int_t nBins){
  
  // std::cout << "*** void SuperImpose3Histos( ) *** Entering Function." << std::endl;
  gPad->Update();
  ...
  // Draw Legends
  Draw3Legends( myLeg, clone1, clone2, clone3, h1_Title, h2_Title, h3_Title, 5);
  gPad->Update();
  
  // std::cout << "*** void SuperImpose3Histos( ) *** Leaving Function." << std::endl;
  
} //end of: void SuperImpose3Histos( TH1D* h1, TH1D* h2, TH1D* h3, TString h1_Title, TString h2_Title, TString h3_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg){
//********************************************************************//
...
// Function to Superimpose 3 histograms, all located in the same path.
//********************************************************************//
void SuperImpose3Histos(  TFile *f1, TString Histo1, TString Histo2, TString Histo3, TString h1_Title, TString h2_Title, TString h3_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg, Int_t nBins){

  //void Superimpose3Histos2Files( TFile *f1, TFile *f2, TString Histo1, TString Histo2, TString Histo3, TString Histo4, Double_t xMin, Double_t xMax, Int_t nBins = 1, TString leg1, TString leg2, TString leg3, TString leg4, TString myLeg,  TString xTitle ){
...
} //end of: void SuperImpose3Histos(  TFile *f1, TString Histo1, TString Histo2, TString Histo3, TString h1_Title, TString h2_Title, TString h3_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg, Int_t nBins){
//********************************************************************//
...
// Function to Superimpose 4 histograms, all located in the same path.
//********************************************************************//
void SuperImpose4Histos( TH1D* h1, TH1D* h2, TH1D* h3,  TH1D* h4, TString h1_Title, TString h2_Title, TString h3_Title, TString h4_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg, Int_t nBins){
...
} //end of: void SuperImpose4Histos( TH1D* h1, TH1D* h2, TH1D* h3,  TH1D* h4, Double_t xMin, Double_t xMax, TString myLeg, Int_t nBins){





// Function to Superimpose 4 histograms NORMALIZED, all located in the same path.
//********************************************************************//
void SuperImpose4HistosNorm( TH1D* h1, TH1D* h2, TH1D* h3,  TH1D* h4, TString h1_Title, TString h2_Title, TString h3_Title, TString h4_Title, Double_t xMin, Double_t xMax, TString xTitle, TString myLeg){
...
} //end of: void SuperImpose4HistosNorm( TH1D* h1, TH1D* h2, TH1D* h3,  TH1D* h4, Double_t xMin, Double_t xMax, TString myLeg){
