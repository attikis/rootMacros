...
xPosList  = [0.0, alpha*0.5, xMax[0]/6]
...
def main():
    ...
    for nu, colour in zip(DOF, colours):
        ...
        chiSquare = ROOT.TF1("ChiSqQuantile", "ROOT::Math::chisquared_pdf(x, [0], [1])", xMin[counter], xMax[counter])
        ...
        chiSquare.GetXaxis().SetBinLabel(alpha*5, "#chi^{2}_{#nu, 1-#alpha}")
